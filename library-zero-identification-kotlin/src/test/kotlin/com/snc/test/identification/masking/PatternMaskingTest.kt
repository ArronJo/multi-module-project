...
class PatternMaskingTest : BaseJUnit5Test() {
    ...
    fun `패턴 마스킹 - 주소 상세주소`() {
        ...
        assertEquals("서울특별시 강남구 테헤란로 123 길동**** 5*", v1)
