...
import com.snc.zero.core.regex.RegularExpr.Companion.PATTERN_PWD_ENG_NUM_SPC
import com.snc.zero.core.regex.RegularExpr.Companion.PATTERN_PWD_ENG_UC_LC_NUM_SPC
...
class RegularExprTest : BaseJUnit5Test() {
    ...
    fun testRegularExpr() {
        ...
        println("PATTERN_PWD_ENG_UC_LC_NUM_SPC_ALL: ${matches(PATTERN_PWD_ENG_UC_LC_NUM_SPC, "Ab1@Ab1@11")}")
        println("PATTERN_PWD_ENG_NUM_SPC: ${matches(PATTERN_PWD_ENG_NUM_SPC, "Ab1@Ab1@11")}")
        println()
    }
}
